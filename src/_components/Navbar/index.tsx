...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed left-0 top-0 z-50 mx-auto w-full bg-background px-4 shadow-md dark:bg-[#131313] md:px-20`}
      >
        <div className="flex items-center justify-between p-2 md:gap-1">
          <Link href={"/"}>
            <div className="flex cursor-pointer items-center justify-center gap-1 text-2xl">
              ...
              <h1
                className={`${toogleSearchBox && "hidden"} font-bold uppercase text-red-500 md:block`}
              >
                MovieFlix
              </h1>
            </div>
